...
tdx_ths_position1536={'Edge': '27,72,910,798','交易信号监控': '1335,180,566,389','东兴证券': '51,205,1083,717',\
        '行业跟随1': '29,220,677,404','人气综合排行榜2.2': '168,0,477,753','通达信金融终端': '191,41,1258,815',\
        '东方财富': '-25600,-25600,159,27','同花顺': '-25600,-25600,159,27','sina_Market-DurationDn.exe': '-6,432,1326,423',\
        ...
        'sina_Monitor.exe': '109,20,1319,520','singleAnalyseUtil.exe': '1046,20,897,359','LinePower.exe': '9,216,761,407',\
