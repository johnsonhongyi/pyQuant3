...
tdx_ths_position1536={'Edge': '25,143,814,718','交易信号监控': '1335,180,566,389','东兴证券': '51,205,1083,717',\
        ...
        'instock_MonitorTK.py': '15,545,761,314',}
# tdx_ths_position1536={'Edge': '25,143,814,718','交易信号监控': '1335,180,566,389','东兴证券': '51,205,1083,717',\
...
tdx_ths_position1920_old={'Edge': '1253,97,680,891','交易信号监控': '1335,180,566,389','行业跟随1': '29,220,677,404',\
        '人气综合排行榜2.2': '168,0,477,753','通达信金融终端(开心果交易版) 副屏一': '984,-815,1258,815','通达信金融终端(开心果交易版)V2025': '30,246,1385,828',\
        '东方财富': '648,67,1267,804','同花顺': '70,33,1557,805','东兴证券': '52,52,1283,704',\
        'sina_Market-DurationDn.exe': '-7,664,1332,423','sina_Market-DurationCXDN.exe': '-7,326,1329,423','sina_Market-DurationUp.exe': '606,664,1321,423',\
        'sina_Monitor-Market-LH.exe': '662,318,1307,409','sina_Monitor.exe': '109,20,1356,519','singleAnalyseUtil.exe': '1001,0,897,359',\
...
tdx_ths_position1920={'Edge': '909,0,680,776','交易信号监控': '1335,180,566,389','行业跟随1': '30,221,677,404',\
        '人气综合排行榜2.2': '169,0,477,753','通达信金融终端(开心果交易版) 副屏一': '984,-815,1258,815','通达信金融终端(开心果交易版)V2025': '183,156,1385,828',\
        '东方财富': '648,67,1267,804','同花顺': '70,33,1557,805','东兴证券': '52,52,1283,704',\
        'sina_Market-DurationDn.py': '-7,664,1332,423','sina_Market-DurationCXDN.py': '-7,326,1329,423','sina_Market-DurationUp.py': '606,664,1321,423',\
        'sina_Monitor-Market-LH.py': '662,318,1307,409','sina_Monitor.py': '109,20,1356,519','singleAnalyseUtil.py': '1001,0,897,359',\
        ...
        'instock_MonitorTK.py': '6,431,758,415',}
...
# tdx_ths_position4644={'Edge': '2153,-859,621,682','交易信号监控': '1232,84,566,389','东兴证券': '51,205,1083,717',\
#         '行业跟随1': '861,0,677,404','人气综合排行榜2.2': '-2,0,478,753','通达信金融终端(开心果交易版) 副屏一': '1260,-829,1174,655',\
#         '通达信金融终端(开心果交易版) 副屏二': '1303,-649,1150,620','通达信金融终端(开心果交易版) 副屏三': '856,-743,1199,704','通达信金融终端(开心果交易版)V2025': '189,3,1216,794',\
...
#         'sina_Monitor-Market-LH.py': '264,306,1307,407','sina_Monitor.py': '933,-1080,1353,503','singleAnalyseUtil.py': '1928,-1080,897,343',\
#         'LinePower.py': '750,33,761,407','instock_Monitor.py': '16,82,1346,439','chantdxpower.exe': '54,71,647,406',\
#         'ths-tdx-web.py': '70,200,159,27','pywin32_mouse.py': '58,162,159,38','开盘啦竞价板块观察1.0': '891,-1043,898,265',\
#         '股票异动数据监控': '2272,-1036,536,979','instock_MonitorTK.py': '15,545,761,314',}
...
tdx_ths_position4644={'通达信金融终端(开心果交易版)V2025': '1121,-947,1362,908','Edge': '2153,-859,621,682','交易信号监控': '1232,84,566,389','东兴证券': '51,205,1083,717',\
        '行业跟随1': '861,0,677,404','人气综合排行榜2.2': '-2,0,478,753','通达信金融终端(开心果交易版) 副屏一': '1260,-829,1174,655',\
        '通达信金融终端(开心果交易版) 副屏二': '1303,-649,1150,620','通达信金融终端(开心果交易版) 副屏三': '856,-743,1199,704',\
        '东方财富': '1449,-858,1354,790','同花顺': '927,-785,1440,785','sina_Market-DurationDn.py': '-6,432,1356,423',\
        'sina_Market-DurationCXDN.py': '10,313,1329,438','sina_Market-DurationDnUP.py': '-6,411,1353,438','sina_Market-DurationUP.py': '119,329,1394,439',\
        'sina_Monitor-Market-LH.py': '264,306,1307,407','sina_Monitor.py': '933,-1050,1353,503','singleAnalyseUtil.py': '1928,-1050,897,343',\
        'LinePower.py': '750,33,761,407','instock_Monitor.py': '16,82,1346,439','chantdxpower.exe': '86,128,649,407',\
        'ths-tdx-web.py': '70,200,159,27','pywin32_mouse.py': '58,162,159,38','开盘啦竞价板块观察1.0': '891,-1043,898,265',\
        'instock_MonitorTK.py': '942,-368,609,251',}
...
tdx_ths_position5376={'Edge': '909,0,680,776','交易信号监控': '1335,180,566,389','东兴证券': '51,205,1083,717',\
        '行业跟随1': '30,221,677,404','人气综合排行榜2.2': '169,0,477,753','通达信金融终端(开心果交易版) 副屏一': '-37,-891,1153,652',\
        '通达信金融终端(开心果交易版) 副屏二': '-43,-27,1170,760','通达信金融终端(开心果交易版) 副屏三': '-1894,-407,1130,639','通达信金融终端(开心果交易版)V2025': '158,40,1700,952',\
        '东方财富': '-1536,604,1250,773','同花顺': '-1355,615,1355,807','sina_Market-DurationDn.py': '-6,432,1356,423',\
        'sina_Market-DurationCXDN.py': '10,313,1329,438','sina_Market-DurationDnUP.py': '-6,374,1353,438','sina_Market-DurationUP.py': '119,329,1394,439',\
        'sina_Monitor-Market-LH.py': '264,306,1307,407','sina_Monitor.py': '109,20,1356,520','singleAnalyseUtil.py': '1046,20,897,359',\
        'LinePower.py': '750,33,761,407','instock_Monitor.py': '16,82,1346,439','chantdxpower.py': '65,87,646,415',\
