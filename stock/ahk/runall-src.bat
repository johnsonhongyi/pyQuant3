...
rem start cmd /k  sina_Monitor.exe
...
rem start cmd /k  instock_Monitor.exe
...
rem start cmd /k singleAnalyseUtil.exe
TIMEOUT /T 5 /NOBREAK
...
rem start cmd /k sina_Market-DurationUP.exe
...
rem start cmd /k  LinePower.exe
TIMEOUT /T 10 /NOBREAK
cd dataBarFeed\
start cmd /k python chantdxpower.py
rem start cmd /k  chantdxpower.exe
...
start cmd /k  filter_resample_Monitor.py
rem start cmd /k  filter_resample_Monitor.exe
