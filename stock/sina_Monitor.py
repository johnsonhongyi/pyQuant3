...
#                    by=ct.Monitor_sort_count, ascending=[0, 0, 0, 0, 1])
                ...
                if st_key_sort in ['1']:
                    ...
                    if 1530 > cct.get_now_time_int() > 950:
                        top_temp = top_all.query('(lasto1d*0.996 < lastp1d < lasto1d*1.003 and lastl1d <ma201d*1.1 and low > lastp1d*0.999) or (b1_v < 1 and lastp1d > high4  and open > lasth1d and lasth1d > upper1 and lasth2d > upper2 and close > upper and not name.str.contains("ST"))')
                        ...
                        top_temp = query('(ral > 2 and fib > 1 and lasto1d*0.99 < lastp1d < lasto1d*1.1 and  lastl1d <ma201d*1.1 and low > lasth1d*0.995) or (b1_v < 1 and per1d > 5 and low >= lastp1d and not name.str.contains("ST"))')
