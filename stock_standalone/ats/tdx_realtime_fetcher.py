...
def get_market_code(stock_code: str) -> int:
    """
    根据股票代码判断通达信标准市场代码 (pytdx 标准协议只有 0 和 1)：
    0 -> 深圳/北交所市场 (000, 001, 002, 003, 300, 301, 302, 920, 83, 87, 88, 43 等)
    1 -> 上海市场 (600, 601, 603, 605, 688, 689, 110, 113, 118, 510, 588 等)
    """
    c = str(stock_code).strip().zfill(6)
    if c.startswith(("60", "68", "99", "11", "51", "58", "90")):
        return 1
    return 0
