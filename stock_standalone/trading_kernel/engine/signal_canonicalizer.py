...
def canonicalize_decision_queue_item(item: Mapping[str, Any]) -> StrategySignal:
    ...
    features = {
        ...
        "swl_prev5": _float(item.get("swl_prev5")),
        "ma5d_prev5": _float(item.get("ma5d_prev5")),
        ...
        "high_prev1": _float(item.get("high_prev1")),
        "high_prev2": _float(item.get("high_prev2")),
        "high_prev3": _float(item.get("high_prev3")),
        "close_prev1": _float(item.get("close_prev1")),
        "open_prev1": _float(item.get("open_prev1")),
        "open": _float(item.get("open")),
        "setup": str(item.get("setup", "") or ""),
        "low_prev1": _float(item.get("low_prev1")),
        "ma60d": _float(item.get("ma60d")),
        "ma60d_prev5": _float(item.get("ma60d_prev5")),
    }
