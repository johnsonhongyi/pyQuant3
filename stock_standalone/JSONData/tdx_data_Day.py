...
def get_tdx_exp_low_or_high_power(code, dt=None, ptype='close', dl=None, end=None, power=False, lastp=False, newdays=None, resample='d', lvoldays=ct.lastdays * 3,detect_calc_support=False):
    '''
    :param code:999999
    :param dayl:Duration Days
    :param type:TDX type
