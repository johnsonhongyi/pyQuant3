...
## 2026-09-24 14:10
- [x] **【TK 系统极限性能优化方案按阶段落地实施（阶段 0 指纹丢帧根治、阶段 3 差分空值双向闭环、阶段 1 排序策略评估）】(`instock_MonitorTK.py`, `tests/test_tk_perf_stage0_telemetry_and_golden_samples.py`, `tests/test_tk_perf_diff_null_fidelity.py`, `tests/test_tk_perf_stage1_sort_strategy.py`, `20260924_1410_task.md`)**：
